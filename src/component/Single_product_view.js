...
<span><i class="fa fa-rupee"></i> 34</span>
</div>
<div class="cart-total-dil pt-2">
<h4>Delivery Charges</h4>
<span><i class="fa fa-rupee"></i> 1</span>
</div>
</div>
...
<div class="cart-item-price"><i class="fa fa-rupee"></i> 10 <span><i class="fa fa-rupee"></i> 15</span></div>
</div>
...
<div class="cart-item-price"><i class="fa fa-rupee"></i> 24 <span><i class="fa fa-rupee"></i> 30</span></div>
</div>
<button type="button" class="cart-close-btn"><i class="uil uil-multiply"></i></button>
</div>
</div>
...
<h4>Total Saving</h4>
<span><i class="fa fa-rupee"></i> 11</span>
</div>
<div class="main-total-cart">
<h2>Total</h2>
<span><i class="fa fa-rupee"></i> 35</span>
</div>
...
</li> <header class="header clearfix">
<div class="top-header-group">
<div class="top-header">
<div class="res_main_logo">
<a href="index.html"><img src="images/dark-logo-1.png" alt=""></a>
...
<span class="user__name">Sunil Singh</span>
...
<li class="nav-item"><a href="shop_grid.html" class="nav-link new_item" title="New Products">New Arrival</a></li>
...
<ul>
<li><div class="main-price color-discount">Discount Price<span><i class="fa-solid fa-indian-rupee-sign"></i> 15</span></div></li>
<li><div class="main-price mrp-price">MRP Price<span><i class="fa-solid fa-indian-rupee-sign"></i> 18</span></div></li>
</ul>
...
<h4>Product Title Here</h4>
<div class="product-price"><i class="fa-solid fa-indian-rupee-sign"></i> 12 <span><i class="fa-solid fa-indian-rupee-sign"></i> 15</span></div>
<div class="qty-cart">
<div class="quantity buttons_added">
<input type="button" value="-" class="minus minus-btn">
<input type="number" step="1" name="quantity" value="1" class="input-text qty text">
...
<p>Available<span>(In Stock)</span></p>
<h4>Product Title Here</h4>
<div class="product-price"><i class="fa-solid fa-indian-rupee-sign"></i> 10 <span><i class="fa-solid fa-indian-rupee-sign"></i> 13</span></div>
<div class="qty-cart">
<div class="quantity buttons_added">
<input type="button" value="-" class="minus minus-btn">
<input type="number" step="1" name="quantity" value="1" class="input-text qty text">
...
<p>Available<span>(In Stock)</span></p>
<h4>Product Title Here</h4>
<div class="product-price"><i class="fa-solid fa-indian-rupee-sign"></i> 5 <span><i class="fa-solid fa-indian-rupee-sign"></i> 8</span></div>
<div class="qty-cart">
<div class="quantity buttons_added">
<input type="button" value="-" class="minus minus-btn">
<input type="number" step="1" name="quantity" value="1" class="input-text qty text">
...
<p>Available<span>(In Stock)</span></p>
<h4>Product Title Here</h4>
<div class="product-price"><i class="fa-solid fa-indian-rupee-sign"></i> 15 <span><i class="fa-solid fa-indian-rupee-sign"></i> 20</span></div>
<div class="qty-cart">
<div class="quantity buttons_added">
<input type="button" value="-" class="minus minus-btn">
<input type="number" step="1" name="quantity" value="1" class="input-text qty text">
...
<p>Available<span>(In Stock)</span></p>
<h4>Product Title Here</h4>
<div class="product-price"><i class="fa-solid fa-indian-rupee-sign"></i> 9 <span><i class="fa-solid fa-indian-rupee-sign"></i> 10</span></div>
<div class="qty-cart">
<div class="quantity buttons_added">
<input type="button" value="-" class="minus minus-btn">
<input type="number" step="1" name="quantity" value="1" class="input-text qty text">
...
<p>Available<span>(In Stock)</span></p>
<h4>Product Title Here</h4>
<div class="product-price"><i class="fa-solid fa-indian-rupee-sign"></i> 7 <span><i class="fa-solid fa-indian-rupee-sign"></i> 8</span></div>
<div class="qty-cart">
<div class="quantity buttons_added">
<input type="button" value="-" class="minus minus-btn">
<input type="number" step="1" name="quantity" value="1" class="input-text qty text">
...
<p>Available<span>(In Stock)</span></p>
<h4>Product Title Here</h4>
<div class="product-price"><i class="fa-solid fa-indian-rupee-sign"></i> 6.95 <span><i class="fa-solid fa-indian-rupee-sign"></i> 7</span></div>
<div class="qty-cart">
<div class="quantity buttons_added">
<input type="button" value="-" class="minus minus-btn">
<input type="number" step="1" name="quantity" value="1" class="input-text qty text">
...
<p>Available<span>(In Stock)</span></p>
<h4>Product Title Here</h4>
<div class="product-price"><i class="fa-solid fa-indian-rupee-sign"></i> 8 <span><i class="fa-solid fa-indian-rupee-sign"></i> 10</span></div>
<div class="qty-cart">
<div class="quantity buttons_added">
<input type="button" value="-" class="minus minus-btn">
<input type="number" step="1" name="quantity" value="1" class="input-text qty text">
...
<li><a href="#" class="callemail"><i class="uil uil-envelope-alt"></i><span>info@grocery.com</span></a></li>
</ul>
</div>
<div class="col-md-6 col-sm-6">
