...
<h4 class="cashbk-price"><i class="fa-solid fa-indian-rupee-sign"></i> 120</h4>
...
<h4 class="cashbk-price"><i class="fa-solid fa-indian-rupee-sign"></i> 5</h4>
...
<div class="ui fluid search dropdown form-dropdown selection"><select name="card[expire-month]">
...
</select><i class="dropdown icon"></i><input class="search" autocomplete="off" tabindex="0"><div class="default text">Month</div><div class="menu" tabindex="-1"><div class="item" data-value="1">January</div><div class="item" data-value="2">February</div><div class="item" data-value="3">March</div><div class="item" data-value="4">April</div><div class="item" data-value="5">May</div><div class="item" data-value="6">June</div><div class="item" data-value="7">July</div><div class="item" data-value="8">August</div><div class="item" data-value="9">September</div><div class="item" data-value="10">October</div><div class="item" data-value="11">November</div><div class="item" data-value="12">December</div></div></div>
</div>
</div>
<div class="col-lg-4 col-md-4">
<div class="form-group mt-1">
...
<div class="ui search focus">
<div class="ui left icon input swdh11 swdh19">
<input class="prompt srch_explore" type="text" name="addbalance" maxlength="3" placeholder="<i class="fa-solid fa-indian-rupee-sign"></i> 0">
</div>
</div>
</div>
</div>
...
<div class="purchase-history-right">
<span>-<i class="fa-solid fa-indian-rupee-sign"></i> 21</span>
<a href="#">View</a>
</div>
</div>
</li>
...
<div class="purchase-history-right">
<span>-<i class="fa-solid fa-indian-rupee-sign"></i> 30</span>
<a href="#">View</a>
</div>
</div>
</li>
